...
*/ // So, I created matching outlets to the same fields, I hope.
  @IBOutlet weak var firstNameTextField: UITextField!
  @IBOutlet weak var lastNameTextField: UITextField!
  @IBOutlet weak var imageView: UIImageView!
...
// first copied this in from demo (if memory serves, it was late at night) ... showed hooked-in, but deleted it and re-made.
